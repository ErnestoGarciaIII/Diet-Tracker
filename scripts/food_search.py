...
def apply_filter(filter_id, connection):
    ...
    filter_map = {
            1: os.path.join(query_dir, "vegetarian_query.sql"),
            2: os.path.join(query_dir, "vegan_query.sql"),
            3: os.path.join(query_dir, "nut_allergy_query.sql"),
            4: os.path.join(query_dir, "egg_allergy_query.sql"),
            5: os.path.join(query_dir, "shellfish_allergy_query.sql"),
            6: os.path.join(query_dir, "soy_allergy_query.sql"),
            7: os.path.join(query_dir, "dairy_allergy_query.sql"),
            8: os.path.join(query_dir, "pescatarian_query.sql"),
